          ...
          <div className="flex items-center space-x-1 sm:space-x-2">
            {tabs.map((tab) => (
              ...
              >
                ...
                <div className={`transition-transform duration-300 ease-in-out ${activeTab === tab.id ? 'scale-110' : 'group-hover:scale-105'}`}>
                  {tab.icon}
                </div>
                
                <span className={`text-xs font-medium mt-1 transition-opacity duration-300 ease-in-out ${
